...
class LanguageControlPanelForm(controlpanel.RegistryEditForm):
    ...
    label = _(u"heading_language_settings", default=u"Language Settings")
    description = _(
        u"description_language_settings",
        default=u"Settings related to interface languages and content "
                u"translations.",
    )
    ...
    def handleSave(self, action):
        ...
        if (
            'default_language' in data and
            'available_languages' in data and
